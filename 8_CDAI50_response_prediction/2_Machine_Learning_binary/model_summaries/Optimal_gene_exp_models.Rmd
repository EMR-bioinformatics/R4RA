...
outputs <- function(model, df3, header_level="####"){
  ...
  # all_features = unique(unlist(lapply(mod, function(x) x$selected_features)))
  # all_features = colnames(exp_sd)[gsub("\\-", ".", colnames(exp_sd)) %in% all_features]
  # all_features = exp_sd[, all_features]
