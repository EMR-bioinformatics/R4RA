...
source("../../3_Plotting_and_summary_scripts/plotting_scripts.r")
library(ggplot2)
library(kableExtra)
library(plotROC)
library(pROC)
...
files = list.files("/media/lvm1/R4RA_ML_outputs", 
                   pattern="all", full.names = T, recursive = T)
...
names(t_nested)[grepl("^_x_", names(t_nested))]=paste0("CDAI50_toc_resp", names(t_nested)[grepl("^_x_", names(t_nested))])
...
```{r}
#save(df, file="/media/gcpeac/R4RA_machine_learning/Data/all_model_summaries2.rdata")
