...
#                                    features = feat, k=k, inner_folds=10, filtering_method = "rfe")))
#     })
...
models <- c("mda", "pda") # "glmnet", "rf",  "svmPoly",  "svmRadial", "gbm",  
...
print(paste0(" -- output to: ", output_dir, "Initial/input_clinical"))
